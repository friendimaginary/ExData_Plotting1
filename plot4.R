...
## Set up the 'canvas' for the four plots

par( mfrow = c(2,2) , mar = c( 4,4,2,1 ) )

##  Plot 1 in this graphic is Plot 2 from this assignment

with( two.days , plot( DateTime , Global_active_power , type = "l" , xlab = "" , ylab = "Global Active Power" ))

##  Plot 2 is new but similar

with( two.days , plot( DateTime , Voltage , type = "l" , xlab = "datetime" , ylab = "Voltage" ))

##  Plot 3 for the graphic is plot 3 from the assigment
...
with(two.days , plot( DateTime , Global_reactive_power , xlab = "datetime" , type = "l" ))
